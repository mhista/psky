...
class AnimatedSectionState extends State<AnimatedSection> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    animController = AnimationController(
      ...
      duration: const Duration(milliseconds: 300),
        ...
        if (status == AnimationStatus.dismissed) widget.animationDismissed();
      });
