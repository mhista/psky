...
import 'package:ahiaa_web/features/authentication/controllers/login/login_controller.dart';
import 'package:ahiaa_web/features/authentication/screens/forget_password/forget_password.dart';
import 'package:ahiaa_web/utils/validators/validation.dart';
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                // forget password
                TextButton(
                  onPressed: () => Get.toNamed(KRoutes.forgetPassword),
