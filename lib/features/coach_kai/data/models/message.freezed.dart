...
extension MessagePatterns on Message {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String id, String content, MessageRole role,
            DateTime updatedAt, MessageState state)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _Message() when $default != null:
        return $default(
            _that.id, _that.content, _that.role, _that.updatedAt, _that.state);
      case _:
        return orElse();
    }
  }
...
/// @nodoc
@JsonSerializable()
class _Message extends Message with DiagnosticableTreeMixin {
  const _Message(
      {required this.id,
