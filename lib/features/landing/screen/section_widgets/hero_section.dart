    ...
    return RepaintBoundary(
      child:isMobile? Column(
        ...
        children: [
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                 ...
                 Text(
                  'Join the waitlist for AI-powered timed mocks and personalised study plans that focus your effort where it matters most.',
                  style: TextStyle(
          ...
          ), child:  Text('Join the waitlist', style: TextStyle(
            fontSize:isMobile? 11 : null, fontWeight:isMobile? FontWeight.w600:  null 
          ),),)
              ],
            ),
          ),
